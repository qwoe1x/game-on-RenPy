...
screen main_menu():
    ...
    text "{color=#FF0000}[config.version]{/color}" at right
...
screen about():
    ...
    use game_menu(_("Об игре"), scroll="viewport"):
        ...
        vbox:
            text("\nChangelog :")
            text("{color=#ff0000}v[config.version](Not Stable){/color}")
            text("{color=#0000ff}Uk trans{/color}{color=#ffff00}lation fixed{/color}")
            text("{color=#00ff00}Story from 0.2.4 reworked{/color}")
            text("{color=#00ff00}Lovemetr file changed{/color}")
            text("{color=#ffffff}v0.2.4(Stable){/color}")
            text("{gradient2=6-#ff0000-#ffff00-10-#ffff00-#00ff00-10-#00ff00-#00ffff-10-#00ffff-#0000ff-10-#0000ff-#ff00ff-10-#ff00ff-#ff0000-10}Story updated{/gradient2}")
            text("{color=#00ff00}New characters{/color}")
            text("{color=#00ff00}Added sounds{/color}")
            text("{color=#00ff00}bg's added{/color}")
            text("{color=#ffffff}v0.2.3(Stable){/color}")
            text("{color=#00ff00}Added Changelog{/color}")
            text("{color=#00ff00}Dev Tools (Shift+D){/color}")
            text("{gradient2=6-#ff0000-#ffff00-10-#ffff00-#00ff00-10-#00ff00-#00ffff-10-#00ffff-#0000ff-10-#0000ff-#ff00ff-10-#ff00ff-#ff0000-10}Story updated{/gradient2}")
            text("{color=#00ff00}Updated bgs{/color}")
            text("{color=#00ff00}Lovemetr file changed{/color}")
            text("{color=#00ff00}Phone avatars updated{/color}")
            text("{color=#00ff00}Music added{/color}")
            text("{color=#0000ff}Uk trans{/color}{color=#ffff00}lation fixed{/color}")
            text("{color=#bed1ff}Code was reorganized and optimized{/color}")
            text("{color=#ffff00}Added assets(pending){/color}")
            text("{color=#ffff00}Added sounds(pending){/color}")

            text ("\nFhurer my love це ADV MOEGE AAA створений за допомогою RenPy висококласними розробниками. На бюджет гри було витрачено 7 dablcola, 5 пачок попкорна, 49 вафель")
        ...
        vbox:
            ...
            hbox:
                ...
                vbox:
                    ...
                    textbutton "Українська" action Language("ukrainian")
