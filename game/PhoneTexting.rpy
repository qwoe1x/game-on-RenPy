...
define MC_Name = "Влад" ##The name of the main character, used to place them on the screen
...
screen nvl_phonetext(dialogue):
    ...
    for id_d, d in enumerate(dialogue):
        if d.who == None: # Narrator
            ...
            if d.who == MC_Name:
                $ message_frame = "phone images/phone_send_frame.png"
            else:
                $ message_frame = "phone images/phone_received_frame.png"
            ...
            hbox:
                ...
                if previous_d_who != d.who:
                    if d.who == MC_Name:
                        $ message_icon = "phone images/phone_send_icon.png"
                    elif d.who == "Бодя":
                        $ message_icon = "phone images/bodya_received_icon.png"
                    elif d.who == "Аліна":
                        $ message_icon = "phone images/alina_received_icon.png"
                    else:
                        $ message_icon = "phone images/phone_received_icon.png"
...
style phoneFrame_frame:
    background Transform("phone images/phone_background.png", xcenter=0.5,yalign=0.5)
    foreground Transform("phone images/phone_foreground.png", xcenter=0.5,yalign=0.5)
