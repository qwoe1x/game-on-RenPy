...
define config.name = ("Fuhrer_My_Love")
...
define gui.about = ("""
Головний герой, Влад, переїжджає в нове місто і вступає в колледж. 
У перший день він випадково зіткнувся з загадковим хлопцем, також на ім'я Влад. 
З першого погляду між ними виникає щось особливе...
""")
...
define build.name = "Fuhrer_My_Love"
...
define config.main_menu_music = "audio/videoplayback.ogg"
...
define config.save_directory = "Fuhrer_My_Love-1704669111"
